...
int main(int argc, char* argv[]) {
    ...
    static struct option long_options[] = {
        ...
        {"call-func-with-explicit-args", optional_argument, nullptr, 'e',}, // add by loujiahang 20230622
        {0, 0, 0, 0,}
    };
    static char* const short_options = (char *)"c:m:o:t:i:p:a:d:e:";
    ...
    bool CallFuncWithExplicitArgs = false;
    ...
    while ((opt = getopt_long(argc, argv, short_options, long_options, nullptr)) != -1) {
        ...
        //   case 'v': verbose = true; break;
            ...
            case 'e': std::istringstream(optarg) >> std::boolalpha >> CallFuncWithExplicitArgs; break;
    ...
    for(auto& dfg_fn : dfg_fns){
        ...
        bool succeed = mapper.execute(dumpCallFunc, dumpMappedViz, resultDir, CallFuncWithExplicitArgs);
        if(!succeed){
            break;
        }
