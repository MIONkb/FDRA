...
module SramAddrGen(
  ...
  wire [18:0] _iNextAddr_T_3 = 2'h1 == Burst ? incrNextAddr : {{3'd0}, CurAddr}; // @[Mux.scala 81:58]
  ...
  assign NextAddr = {CurAddr[15:12],iNextAddr}; // @[Cat.scala 33:92]
endmodule
module WriteEngine(
  input         aclk,
  input         aresetn,
...
`ifdef RANDOMIZE_REG_INIT
  ...
  reg [31:0] _RAND_5;
`endif // RANDOMIZE_REG_INIT
  wire [15:0] NextAddr_m_CurAddr; // @[SramAddrGen.scala 50:23]
  ...
  wire [15:0] NextAddr_m_NextAddr; // @[SramAddrGen.scala 50:23]
  ...
  reg [15:0] iAddr; // @[WriteEngine.scala 77:34]
  wire [15:0] NextAddr = NextAddr_m_NextAddr; // @[WriteEngine.scala 79:31 80:21]
  wire [15:0] _GEN_12 = s_axi_w_valid ? NextAddr : iAddr; // @[WriteEngine.scala 130:42 133:29 137:29]
  wire [1:0] _GEN_13 = s_axi_w_bits_last & s_axi_w_valid ? 2'h3 : state; // @[WriteEngine.scala 120:63 127:29]
  wire [15:0] _GEN_14 = s_axi_w_bits_last & s_axi_w_valid ? iAddr : _GEN_12; // @[WriteEngine.scala 120:63 128:29]
  ...
  always @(posedge aclk or posedge reset) begin
    if (reset) begin // @[WriteEngine.scala 90:23]
      iAddr <= 16'h0; // @[WriteEngine.scala 77:34 92:38 97:37]
    end else if (2'h0 == state) begin // @[WriteEngine.scala 90:23]
      if (s_axi_aw_valid) begin // @[WriteEngine.scala 110:29]
...
`endif // RANDOMIZE_REG_INIT
  ...
  reg [15:0] iAddr; // @[ReadEngine.scala 84:34]
  wire [15:0] NextAddr = NextAddr_m_NextAddr; // @[ReadEngine.scala 86:31 87:21]
  ...
  wire [15:0] _iAddr_T = s_axi_r_ready ? NextAddr : iAddr; // @[ReadEngine.scala 153:35]
  wire [1:0] _GEN_20 = leftLen == 8'h1 ? _state_T : state; // @[ReadEngine.scala 145:45 152:29]
  wire [15:0] _GEN_21 = leftLen == 8'h1 ? _iAddr_T : _iAddr_T; // @[ReadEngine.scala 145:45 153:29]
  ...
  wire [15:0] _GEN_30 = s_axi_r_ready ? 16'h0 : iAddr; // @[ReadEngine.scala 174:36 177:29 189:29]
  ...
  always @(posedge aclk or posedge reset) begin
    if (reset) begin // @[ReadEngine.scala 97:23]
      iAddr <= 16'h0; // @[ReadEngine.scala 104:37 84:34 99:38]
    end else if (2'h0 == state) begin // @[ReadEngine.scala 97:23]
      if (s_axi_ar_valid) begin // @[ReadEngine.scala 117:29]
...
module AXI4Scratchpad(
  ...
  input  [15:0] io_s_axi_aw_bits_addr,
  ...
  input  [15:0] io_s_axi_ar_bits_addr,
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [15:0] wrIE_s_axi_aw_bits_addr; // @[AxiScratchpad.scala 130:25]
  ...
  wire [15:0] wrIE_addr; // @[AxiScratchpad.scala 130:25]
  ...
  wire [15:0] rdIE_s_axi_ar_bits_addr; // @[AxiScratchpad.scala 131:25]
  ...
  wire [15:0] rdIE_addr; // @[AxiScratchpad.scala 131:25]
  ...
  wire [2:0] arbiter_wr_cs; // @[AxiScratchpad.scala 132:25]
  wire [2:0] arbiter_rd_cs; // @[AxiScratchpad.scala 132:25]
  wire [2:0] wr_csel = wrIE_addr[15:13]; // @[AxiScratchpad.scala 137:34]
  wire [9:0] wr_spad_addr = wrIE_addr[12:3]; // @[AxiScratchpad.scala 138:34]
  wire [2:0] rd_csel = rdIE_addr[15:13]; // @[AxiScratchpad.scala 139:34]
  wire [9:0] rd_spad_addr = rdIE_addr[12:3]; // @[AxiScratchpad.scala 140:34]
  reg [2:0] currentRdBank; // @[AxiScratchpad.scala 164:32]
  wire [63:0] _rdIE_data_T_1 = 3'h0 == currentRdBank ? TrueDualPortSRAMAsym_io_a_dout : 64'h0; // @[Mux.scala 81:58]
  wire [63:0] _rdIE_data_T_3 = 3'h1 == currentRdBank ? TrueDualPortSRAMAsym_1_io_a_dout : _rdIE_data_T_1; // @[Mux.scala 81:58]
  wire [63:0] _rdIE_data_T_5 = 3'h2 == currentRdBank ? TrueDualPortSRAMAsym_2_io_a_dout : _rdIE_data_T_3; // @[Mux.scala 81:58]
  wire [63:0] _rdIE_data_T_7 = 3'h3 == currentRdBank ? TrueDualPortSRAMAsym_3_io_a_dout : _rdIE_data_T_5; // @[Mux.scala 81:58]
  wire  _en_T = wr_csel == 3'h0; // @[AxiScratchpad.scala 175:25]
  wire  _en_T_2 = rd_csel == 3'h0; // @[AxiScratchpad.scala 175:58]
  wire  en = wr_csel == 3'h0 & wrIE_ready | rd_csel == 3'h0 & rdIE_ready; // @[AxiScratchpad.scala 175:47]
  ...
  wire  _en_T_4 = wr_csel == 3'h1; // @[AxiScratchpad.scala 175:25]
  wire  _en_T_6 = rd_csel == 3'h1; // @[AxiScratchpad.scala 175:58]
  wire  en_1 = wr_csel == 3'h1 & wrIE_ready | rd_csel == 3'h1 & rdIE_ready; // @[AxiScratchpad.scala 175:47]
  ...
  wire  _en_T_8 = wr_csel == 3'h2; // @[AxiScratchpad.scala 175:25]
  wire  _en_T_10 = rd_csel == 3'h2; // @[AxiScratchpad.scala 175:58]
  wire  en_2 = wr_csel == 3'h2 & wrIE_ready | rd_csel == 3'h2 & rdIE_ready; // @[AxiScratchpad.scala 175:47]
  ...
  wire  _en_T_12 = wr_csel == 3'h3; // @[AxiScratchpad.scala 175:25]
  wire  _en_T_14 = rd_csel == 3'h3; // @[AxiScratchpad.scala 175:58]
  wire  en_3 = wr_csel == 3'h3 & wrIE_ready | rd_csel == 3'h3 & rdIE_ready; // @[AxiScratchpad.scala 175:47]
  ...
  wire  _en_last_T = wr_csel == 3'h4; // @[AxiScratchpad.scala 200:28]
  wire  en_last = wr_csel == 3'h4 & wrIE_ready | rd_csel == 3'h4 & rdIE_ready; // @[AxiScratchpad.scala 200:61]
  wire  we_last = _we_T & _en_last_T; // @[AxiScratchpad.scala 201:43]
  wire  re_last = _re_T & _en_last_T; // @[AxiScratchpad.scala 202:43]
  wire [9:0] _T_8 = we_last ? wr_spad_addr : rd_spad_addr; // @[AxiScratchpad.scala 204:40]
  ...
  assign TrueDualPortSRAM_64_9_io_a_addr = _T_8[8:0];
  ...
  assign rdIE_data = 3'h4 == currentRdBank ? TrueDualPortSRAM_64_9_io_a_dout : _rdIE_data_T_7; // @[Mux.scala 81:58]
  assign arbiter_wrvalid = wrIE_valid; // @[AxiScratchpad.scala 169:21]
  assign arbiter_rdvalid = rdIE_valid; // @[AxiScratchpad.scala 170:21]
  assign arbiter_wr_cs = wrIE_addr[15:13]; // @[AxiScratchpad.scala 137:34]
  assign arbiter_rd_cs = rdIE_addr[15:13]; // @[AxiScratchpad.scala 139:34]
  always @(posedge io_aclk) begin
    currentRdBank <= rdIE_addr[15:13]; // @[AxiScratchpad.scala 139:34]
  end
// Register and memory initialization
`ifdef RANDOMIZE_GARBAGE_ASSIGN
`define RANDOMIZE
...
module IOB_2(
  ...
  assign cfg_clock = clock;
  assign cfg_reset = reset;
  assign cfg_io_cfg_en = io_cfg_en & 9'hd == io_cfg_addr[11:3]; // @[IOB.scala 153:30]
  assign cfg_io_cfg_addr = io_cfg_addr[2:0]; // @[IOB.scala 154:33]
  assign cfg_io_cfg_data = io_cfg_data; // @[IOB.scala 155:19]
endmodule
module IOB_3(
  ...
  assign cfg_clock = clock;
  assign cfg_reset = reset;
  assign cfg_io_cfg_en = io_cfg_en & 9'he == io_cfg_addr[11:3]; // @[IOB.scala 153:30]
  assign cfg_io_cfg_addr = io_cfg_addr[2:0]; // @[IOB.scala 154:33]
  assign cfg_io_cfg_data = io_cfg_data; // @[IOB.scala 155:19]
endmodule
module ALU(
...
module GPE_2(
  ...
  assign cfg_clock = clock;
  assign cfg_reset = reset;
  assign cfg_io_cfg_en = io_cfg_en & 9'h9 == io_cfg_addr[11:3]; // @[PE.scala 282:30]
  assign cfg_io_cfg_addr = io_cfg_addr[1:0]; // @[PE.scala 283:19]
  assign cfg_io_cfg_data = io_cfg_data; // @[PE.scala 284:19]
endmodule
module GPE_3(
  ...
  assign cfg_clock = clock;
  assign cfg_reset = reset;
  assign cfg_io_cfg_en = io_cfg_en & 9'ha == io_cfg_addr[11:3]; // @[PE.scala 282:30]
  assign cfg_io_cfg_addr = io_cfg_addr[1:0]; // @[PE.scala 283:19]
  assign cfg_io_cfg_data = io_cfg_data; // @[PE.scala 284:19]
endmodule
module GIB(
...
`endif // RANDOMIZE_REG_INIT
  ...
  ConfigMem_8 cfg ( // @[Interconnect.scala 490:21]
    .clock(cfg_clock),
    .reset(cfg_reset),
    .io_cfg_en(cfg_io_cfg_en),
    .io_cfg_data(cfg_io_cfg_data),
...
`endif // RANDOMIZE_REG_INIT
  ...
  reg [15:0] io_otrackE_0_REG; // @[Interconnect.scala 504:55]
  reg [15:0] io_otrackS_0_REG; // @[Interconnect.scala 504:55]
  ConfigMem_9 cfg ( // @[Interconnect.scala 490:21]
    .clock(cfg_clock),
    .reset(cfg_reset),
    .io_cfg_en(cfg_io_cfg_en),
    .io_cfg_data(cfg_io_cfg_data),
...
module GIB_3(
  ...
  wire [15:0] mux_3_io_out; // @[Interconnect.scala 500:25]
  ConfigMem_10 cfg ( // @[Interconnect.scala 490:21]
    .clock(cfg_clock),
    .reset(cfg_reset),
    .io_cfg_en(cfg_io_cfg_en),
    .io_cfg_data(cfg_io_cfg_data),
  ...
  Muxn_23 mux ( // @[Interconnect.scala 500:25]
    .io_config(mux_io_config),
    .io_in_0(mux_io_in_0),
    .io_in_1(mux_io_in_1),
    .io_in_2(mux_io_in_2),
  ...
  Muxn_23 mux_1 ( // @[Interconnect.scala 500:25]
    .io_config(mux_1_io_config),
    .io_in_0(mux_1_io_in_0),
    .io_in_1(mux_1_io_in_1),
  ...
  Muxn_23 mux_2 ( // @[Interconnect.scala 500:25]
    .io_config(mux_2_io_config),
    .io_in_0(mux_2_io_in_0),
    .io_in_1(mux_2_io_in_1),
  ...
  Muxn_23 mux_3 ( // @[Interconnect.scala 500:25]
    .io_config(mux_3_io_config),
    .io_in_0(mux_3_io_in_0),
    .io_in_1(mux_3_io_in_1),
...
`endif // RANDOMIZE_REG_INIT
  ...
  assign cfg_clock = clock;
  assign cfg_reset = reset;
  assign cfg_io_cfg_en = io_cfg_en & 9'hc == io_cfg_addr[11:3]; // @[Interconnect.scala 491:32]
  assign cfg_io_cfg_data = io_cfg_data; // @[Interconnect.scala 493:21]
  assign mux_io_config = cfg_io_out_0[0]; // @[Interconnect.scala 510:39]
...
`ifdef RANDOMIZE_REG_INIT
  reg [31:0] _RAND_0;
`endif // RANDOMIZE_REG_INIT
  wire  iobs_0_clock; // @[MultiTileCGRA.scala 229:25]
  wire  iobs_0_reset; // @[MultiTileCGRA.scala 229:25]
  wire  iobs_0_io_cfg_en; // @[MultiTileCGRA.scala 229:25]
  wire [11:0] iobs_0_io_cfg_addr; // @[MultiTileCGRA.scala 229:25]
  wire [31:0] iobs_0_io_cfg_data; // @[MultiTileCGRA.scala 229:25]
  wire  iobs_0_io_start; // @[MultiTileCGRA.scala 229:25]
  wire  iobs_0_io_done; // @[MultiTileCGRA.scala 229:25]
  wire  iobs_0_io_en; // @[MultiTileCGRA.scala 229:25]
  wire [15:0] iobs_0_io_in_1; // @[MultiTileCGRA.scala 229:25]
  wire [15:0] iobs_0_io_out_0; // @[MultiTileCGRA.scala 229:25]
  wire  iobs_0_io_sram_en; // @[MultiTileCGRA.scala 229:25]
  wire [1:0] iobs_0_io_sram_we; // @[MultiTileCGRA.scala 229:25]
  wire [14:0] iobs_0_io_sram_addr; // @[MultiTileCGRA.scala 229:25]
  wire [15:0] iobs_0_io_sram_din; // @[MultiTileCGRA.scala 229:25]
  wire [15:0] iobs_0_io_sram_dout; // @[MultiTileCGRA.scala 229:25]
  wire  iobs_1_clock; // @[MultiTileCGRA.scala 229:25]
  wire  iobs_1_reset; // @[MultiTileCGRA.scala 229:25]
  wire  iobs_1_io_cfg_en; // @[MultiTileCGRA.scala 229:25]
  wire [11:0] iobs_1_io_cfg_addr; // @[MultiTileCGRA.scala 229:25]
  wire [31:0] iobs_1_io_cfg_data; // @[MultiTileCGRA.scala 229:25]
  wire  iobs_1_io_start; // @[MultiTileCGRA.scala 229:25]
  wire  iobs_1_io_done; // @[MultiTileCGRA.scala 229:25]
  wire  iobs_1_io_en; // @[MultiTileCGRA.scala 229:25]
  wire [15:0] iobs_1_io_in_0; // @[MultiTileCGRA.scala 229:25]
  wire [15:0] iobs_1_io_out_0; // @[MultiTileCGRA.scala 229:25]
  wire  iobs_1_io_sram_en; // @[MultiTileCGRA.scala 229:25]
  wire [1:0] iobs_1_io_sram_we; // @[MultiTileCGRA.scala 229:25]
  wire [14:0] iobs_1_io_sram_addr; // @[MultiTileCGRA.scala 229:25]
  wire [15:0] iobs_1_io_sram_din; // @[MultiTileCGRA.scala 229:25]
  wire [15:0] iobs_1_io_sram_dout; // @[MultiTileCGRA.scala 229:25]
  wire  iobs_2_clock; // @[MultiTileCGRA.scala 229:25]
  wire  iobs_2_reset; // @[MultiTileCGRA.scala 229:25]
  wire  iobs_2_io_cfg_en; // @[MultiTileCGRA.scala 229:25]
  wire [11:0] iobs_2_io_cfg_addr; // @[MultiTileCGRA.scala 229:25]
  wire [31:0] iobs_2_io_cfg_data; // @[MultiTileCGRA.scala 229:25]
  wire  iobs_2_io_start; // @[MultiTileCGRA.scala 229:25]
  wire  iobs_2_io_done; // @[MultiTileCGRA.scala 229:25]
  wire  iobs_2_io_en; // @[MultiTileCGRA.scala 229:25]
  wire [15:0] iobs_2_io_in_1; // @[MultiTileCGRA.scala 229:25]
  wire [15:0] iobs_2_io_out_0; // @[MultiTileCGRA.scala 229:25]
  wire  iobs_2_io_sram_en; // @[MultiTileCGRA.scala 229:25]
  wire [1:0] iobs_2_io_sram_we; // @[MultiTileCGRA.scala 229:25]
  wire [14:0] iobs_2_io_sram_addr; // @[MultiTileCGRA.scala 229:25]
  wire [15:0] iobs_2_io_sram_din; // @[MultiTileCGRA.scala 229:25]
  wire [15:0] iobs_2_io_sram_dout; // @[MultiTileCGRA.scala 229:25]
  wire  iobs_3_clock; // @[MultiTileCGRA.scala 229:25]
  wire  iobs_3_reset; // @[MultiTileCGRA.scala 229:25]
  wire  iobs_3_io_cfg_en; // @[MultiTileCGRA.scala 229:25]
  wire [11:0] iobs_3_io_cfg_addr; // @[MultiTileCGRA.scala 229:25]
  wire [31:0] iobs_3_io_cfg_data; // @[MultiTileCGRA.scala 229:25]
  wire  iobs_3_io_start; // @[MultiTileCGRA.scala 229:25]
  wire  iobs_3_io_done; // @[MultiTileCGRA.scala 229:25]
  wire  iobs_3_io_en; // @[MultiTileCGRA.scala 229:25]
  wire [15:0] iobs_3_io_in_0; // @[MultiTileCGRA.scala 229:25]
  wire [15:0] iobs_3_io_out_0; // @[MultiTileCGRA.scala 229:25]
  wire  iobs_3_io_sram_en; // @[MultiTileCGRA.scala 229:25]
  wire [1:0] iobs_3_io_sram_we; // @[MultiTileCGRA.scala 229:25]
  wire [14:0] iobs_3_io_sram_addr; // @[MultiTileCGRA.scala 229:25]
  wire [15:0] iobs_3_io_sram_din; // @[MultiTileCGRA.scala 229:25]
  wire [15:0] iobs_3_io_sram_dout; // @[MultiTileCGRA.scala 229:25]
  ...
  wire [15:0] gibs_0_io_opinNE_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_0_io_ipinSE_1; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_0_io_itrackE_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_0_io_otrackE_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_0_io_itrackS_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_0_io_otrackS_0; // @[MultiTileCGRA.scala 393:23]
  wire  gibs_1_clock; // @[MultiTileCGRA.scala 393:23]
  wire  gibs_1_reset; // @[MultiTileCGRA.scala 393:23]
  wire  gibs_1_io_cfg_en; // @[MultiTileCGRA.scala 393:23]
  wire [11:0] gibs_1_io_cfg_addr; // @[MultiTileCGRA.scala 393:23]
  wire [31:0] gibs_1_io_cfg_data; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_1_io_ipinNW_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_1_io_opinNW_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_1_io_ipinNE_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_1_io_opinNE_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_1_io_ipinSE_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_1_io_ipinSE_1; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_1_io_opinSE_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_1_io_ipinSW_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_1_io_itrackW_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_1_io_otrackW_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_1_io_itrackE_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_1_io_otrackE_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_1_io_itrackS_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_1_io_otrackS_0; // @[MultiTileCGRA.scala 393:23]
  wire  gibs_2_clock; // @[MultiTileCGRA.scala 393:23]
  wire  gibs_2_reset; // @[MultiTileCGRA.scala 393:23]
  wire  gibs_2_io_cfg_en; // @[MultiTileCGRA.scala 393:23]
  wire [11:0] gibs_2_io_cfg_addr; // @[MultiTileCGRA.scala 393:23]
  wire [31:0] gibs_2_io_cfg_data; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_2_io_itrackN_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_2_io_otrackN_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_2_io_itrackE_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_2_io_otrackE_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_2_io_itrackS_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_2_io_otrackS_0; // @[MultiTileCGRA.scala 393:23]
  wire  gibs_3_clock; // @[MultiTileCGRA.scala 393:23]
  wire  gibs_3_reset; // @[MultiTileCGRA.scala 393:23]
  wire  gibs_3_io_cfg_en; // @[MultiTileCGRA.scala 393:23]
  wire [11:0] gibs_3_io_cfg_addr; // @[MultiTileCGRA.scala 393:23]
  wire [31:0] gibs_3_io_cfg_data; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_3_io_ipinNW_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_3_io_opinNW_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_3_io_ipinNE_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_3_io_ipinSE_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_3_io_opinSE_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_3_io_ipinSW_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_3_io_itrackW_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_3_io_otrackW_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_3_io_itrackN_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_3_io_otrackN_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_3_io_itrackE_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_3_io_otrackE_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_3_io_itrackS_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_3_io_otrackS_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_4_io_itrackN_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_4_io_otrackN_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_4_io_itrackE_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_4_io_otrackE_0; // @[MultiTileCGRA.scala 393:23]
  wire  gibs_5_clock; // @[MultiTileCGRA.scala 393:23]
  wire  gibs_5_reset; // @[MultiTileCGRA.scala 393:23]
  wire  gibs_5_io_cfg_en; // @[MultiTileCGRA.scala 393:23]
  wire [11:0] gibs_5_io_cfg_addr; // @[MultiTileCGRA.scala 393:23]
  wire [31:0] gibs_5_io_cfg_data; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_5_io_ipinNW_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_5_io_ipinNW_1; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_5_io_opinNW_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_5_io_ipinNE_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_5_io_ipinSE_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_5_io_opinSE_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_5_io_ipinSW_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_5_io_opinSW_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_5_io_itrackW_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_5_io_otrackW_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_5_io_itrackN_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_5_io_otrackN_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_5_io_itrackE_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_5_io_otrackE_0; // @[MultiTileCGRA.scala 393:23]
  wire [15:0] gibs_6_io_itrackW_0; // @[MultiTileCGRA.scala 847:23]
  wire [15:0] gibs_6_io_otrackW_0; // @[MultiTileCGRA.scala 847:23]
  wire [15:0] gibs_6_io_itrackS_0; // @[MultiTileCGRA.scala 847:23]
  wire [15:0] gibs_6_io_otrackS_0; // @[MultiTileCGRA.scala 847:23]
  wire  gibs_7_clock; // @[MultiTileCGRA.scala 847:23]
  wire  gibs_7_reset; // @[MultiTileCGRA.scala 847:23]
  wire  gibs_7_io_cfg_en; // @[MultiTileCGRA.scala 847:23]
  wire [11:0] gibs_7_io_cfg_addr; // @[MultiTileCGRA.scala 847:23]
  wire [31:0] gibs_7_io_cfg_data; // @[MultiTileCGRA.scala 847:23]
  wire [15:0] gibs_7_io_itrackW_0; // @[MultiTileCGRA.scala 847:23]
  wire [15:0] gibs_7_io_otrackW_0; // @[MultiTileCGRA.scala 847:23]
  wire [15:0] gibs_7_io_itrackN_0; // @[MultiTileCGRA.scala 847:23]
  wire [15:0] gibs_7_io_otrackN_0; // @[MultiTileCGRA.scala 847:23]
  wire [15:0] gibs_7_io_itrackS_0; // @[MultiTileCGRA.scala 847:23]
  wire [15:0] gibs_7_io_otrackS_0; // @[MultiTileCGRA.scala 847:23]
  wire [15:0] gibs_8_io_ipinNW_1; // @[MultiTileCGRA.scala 847:23]
  wire [15:0] gibs_8_io_opinSW_0; // @[MultiTileCGRA.scala 847:23]
  wire [15:0] gibs_8_io_itrackW_0; // @[MultiTileCGRA.scala 847:23]
  wire [15:0] gibs_8_io_otrackW_0; // @[MultiTileCGRA.scala 847:23]
  wire [15:0] gibs_8_io_itrackN_0; // @[MultiTileCGRA.scala 847:23]
  wire [15:0] gibs_8_io_otrackN_0; // @[MultiTileCGRA.scala 847:23]
  wire  done_0 = iobs_0_io_done | ~io_iob_ens_0[0]; // @[MultiTileCGRA.scala 548:30]
  wire  done_1 = iobs_1_io_done | ~io_iob_ens_0[1]; // @[MultiTileCGRA.scala 548:30]
  wire  done_2 = iobs_2_io_done | ~io_iob_ens_0[2]; // @[MultiTileCGRA.scala 548:30]
  wire  done_3 = iobs_3_io_done | ~io_iob_ens_0[3]; // @[MultiTileCGRA.scala 548:30]
  wire [1:0] io_done_0_lo = {done_1,done_0}; // @[MultiTileCGRA.scala 647:35]
  wire [1:0] io_done_0_hi = {done_3,done_2}; // @[MultiTileCGRA.scala 647:35]
  reg [3:0] io_done_0_REG; // @[MultiTileCGRA.scala 647:29]
  IOB iobs_0 ( // @[MultiTileCGRA.scala 229:25]
    .clock(iobs_0_clock),
    .reset(iobs_0_reset),
  ...
  IOB_1 iobs_1 ( // @[MultiTileCGRA.scala 229:25]
    .clock(iobs_1_clock),
    .reset(iobs_1_reset),
  ...
  IOB_2 iobs_2 ( // @[MultiTileCGRA.scala 229:25]
    .clock(iobs_2_clock),
    .reset(iobs_2_reset),
  ...
  IOB_3 iobs_3 ( // @[MultiTileCGRA.scala 229:25]
    .clock(iobs_3_clock),
    .reset(iobs_3_reset),
  ...
  GIB gibs_0 ( // @[MultiTileCGRA.scala 393:23]
  ...
  GIB_1 gibs_1 ( // @[MultiTileCGRA.scala 393:23]
    .clock(gibs_1_clock),
    .reset(gibs_1_reset),
  ...
  GIB_2 gibs_2 ( // @[MultiTileCGRA.scala 393:23]
    .clock(gibs_2_clock),
    .reset(gibs_2_reset),
  ...
  GIB_3 gibs_3 ( // @[MultiTileCGRA.scala 393:23]
    .clock(gibs_3_clock),
    .reset(gibs_3_reset),
  ...
  GIB_4 gibs_4 ( // @[MultiTileCGRA.scala 393:23]
  ...
  GIB_5 gibs_5 ( // @[MultiTileCGRA.scala 393:23]
    .clock(gibs_5_clock),
    .reset(gibs_5_reset),
  ...
  GIB_6 gibs_6 ( // @[MultiTileCGRA.scala 847:23]
  ...
  GIB_7 gibs_7 ( // @[MultiTileCGRA.scala 847:23]
    .clock(gibs_7_clock),
    .reset(gibs_7_reset),
  ...
  GIB_8 gibs_8 ( // @[MultiTileCGRA.scala 847:23]
  ...
  assign io_done_0 = io_done_0_REG[0]; // @[MultiTileCGRA.scala 647:19]
  assign io_srams_0_0_en = iobs_0_io_sram_en; // @[MultiTileCGRA.scala 547:19]
  assign io_srams_0_0_we = iobs_0_io_sram_we; // @[MultiTileCGRA.scala 547:19]
  assign io_srams_0_0_addr = iobs_0_io_sram_addr; // @[MultiTileCGRA.scala 547:19]
  assign io_srams_0_0_din = iobs_0_io_sram_din; // @[MultiTileCGRA.scala 547:19]
  assign io_srams_0_1_en = iobs_1_io_sram_en; // @[MultiTileCGRA.scala 547:19]
  assign io_srams_0_1_we = iobs_1_io_sram_we; // @[MultiTileCGRA.scala 547:19]
  assign io_srams_0_1_addr = iobs_1_io_sram_addr; // @[MultiTileCGRA.scala 547:19]
  assign io_srams_0_1_din = iobs_1_io_sram_din; // @[MultiTileCGRA.scala 547:19]
  assign io_srams_0_2_en = iobs_2_io_sram_en; // @[MultiTileCGRA.scala 547:19]
  assign io_srams_0_2_we = iobs_2_io_sram_we; // @[MultiTileCGRA.scala 547:19]
  assign io_srams_0_2_addr = iobs_2_io_sram_addr; // @[MultiTileCGRA.scala 547:19]
  assign io_srams_0_2_din = iobs_2_io_sram_din; // @[MultiTileCGRA.scala 547:19]
  assign io_srams_0_3_en = iobs_3_io_sram_en; // @[MultiTileCGRA.scala 547:19]
  assign io_srams_0_3_we = iobs_3_io_sram_we; // @[MultiTileCGRA.scala 547:19]
  assign io_srams_0_3_addr = iobs_3_io_sram_addr; // @[MultiTileCGRA.scala 547:19]
  assign io_srams_0_3_din = iobs_3_io_sram_din; // @[MultiTileCGRA.scala 547:19]
  assign iobs_0_clock = clock;
  assign iobs_0_reset = reset;
  assign iobs_0_io_cfg_en = io_cfg_en_0; // @[MultiTileCGRA.scala 1025:23]
  assign iobs_0_io_cfg_addr = io_cfg_addr; // @[MultiTileCGRA.scala 1027:23]
  assign iobs_0_io_cfg_data = io_cfg_data; // @[MultiTileCGRA.scala 1028:23]
  assign iobs_0_io_start = io_start_0 & io_iob_ens_0[0]; // @[MultiTileCGRA.scala 545:38]
  assign iobs_0_io_en = io_en_0 & io_iob_ens_0[0]; // @[MultiTileCGRA.scala 546:32]
  assign iobs_0_io_in_1 = gibs_1_io_ipinNW_0; // @[MultiTileCGRA.scala 558:16]
  assign iobs_0_io_sram_dout = io_srams_0_0_dout; // @[MultiTileCGRA.scala 547:19]
  assign iobs_1_clock = clock;
  assign iobs_1_reset = reset;
  assign iobs_1_io_cfg_en = io_cfg_en_0; // @[MultiTileCGRA.scala 1025:23]
  assign iobs_1_io_cfg_addr = io_cfg_addr; // @[MultiTileCGRA.scala 1027:23]
  assign iobs_1_io_cfg_data = io_cfg_data; // @[MultiTileCGRA.scala 1028:23]
  assign iobs_1_io_start = io_start_0 & io_iob_ens_0[1]; // @[MultiTileCGRA.scala 545:38]
  assign iobs_1_io_en = io_en_0 & io_iob_ens_0[1]; // @[MultiTileCGRA.scala 546:32]
  assign iobs_1_io_in_0 = gibs_1_io_ipinNE_0; // @[MultiTileCGRA.scala 576:16]
  assign iobs_1_io_sram_dout = io_srams_0_1_dout; // @[MultiTileCGRA.scala 547:19]
  assign iobs_2_clock = clock;
  assign iobs_2_reset = reset;
  assign iobs_2_io_cfg_en = io_cfg_en_0; // @[MultiTileCGRA.scala 1025:23]
  assign iobs_2_io_cfg_addr = io_cfg_addr; // @[MultiTileCGRA.scala 1027:23]
  assign iobs_2_io_cfg_data = io_cfg_data; // @[MultiTileCGRA.scala 1028:23]
  assign iobs_2_io_start = io_start_0 & io_iob_ens_0[2]; // @[MultiTileCGRA.scala 545:38]
  assign iobs_2_io_en = io_en_0 & io_iob_ens_0[2]; // @[MultiTileCGRA.scala 546:32]
  assign iobs_2_io_in_1 = gibs_5_io_ipinSW_0; // @[MultiTileCGRA.scala 601:16]
  assign iobs_2_io_sram_dout = io_srams_0_2_dout; // @[MultiTileCGRA.scala 547:19]
  assign iobs_3_clock = clock;
  assign iobs_3_reset = reset;
  assign iobs_3_io_cfg_en = io_cfg_en_0; // @[MultiTileCGRA.scala 1025:23]
  assign iobs_3_io_cfg_addr = io_cfg_addr; // @[MultiTileCGRA.scala 1027:23]
  assign iobs_3_io_cfg_data = io_cfg_data; // @[MultiTileCGRA.scala 1028:23]
  assign iobs_3_io_start = io_start_0 & io_iob_ens_0[3]; // @[MultiTileCGRA.scala 545:38]
  assign iobs_3_io_en = io_en_0 & io_iob_ens_0[3]; // @[MultiTileCGRA.scala 546:32]
  assign iobs_3_io_in_0 = gibs_5_io_ipinSE_0; // @[MultiTileCGRA.scala 621:16]
  assign iobs_3_io_sram_dout = io_srams_0_3_dout; // @[MultiTileCGRA.scala 547:19]
  assign pes_0_clock = clock;
  assign pes_0_reset = reset;
  assign pes_0_io_cfg_en = io_cfg_en_0; // @[MultiTileCGRA.scala 1041:70]
  assign pes_0_io_cfg_addr = io_cfg_addr; // @[MultiTileCGRA.scala 1043:70]
  assign pes_0_io_cfg_data = io_cfg_data; // @[MultiTileCGRA.scala 1044:70]
  assign pes_0_io_start = io_start_0; // @[MultiTileCGRA.scala 658:29]
  assign pes_0_io_en = io_en_0; // @[MultiTileCGRA.scala 659:26]
  assign pes_0_io_in_1 = gibs_1_io_ipinSW_0; // @[MultiTileCGRA.scala 678:40]
  assign pes_0_io_in_3 = gibs_3_io_ipinNW_0; // @[MultiTileCGRA.scala 697:40]
  assign pes_0_io_in_4 = gibs_0_io_ipinSE_1; // @[MultiTileCGRA.scala 669:40]
  assign pes_1_clock = clock;
  assign pes_1_reset = reset;
  assign pes_1_io_cfg_en = io_cfg_en_0; // @[MultiTileCGRA.scala 1041:70]
  assign pes_1_io_cfg_addr = io_cfg_addr; // @[MultiTileCGRA.scala 1043:70]
  assign pes_1_io_cfg_data = io_cfg_data; // @[MultiTileCGRA.scala 1044:70]
  assign pes_1_io_start = io_start_0; // @[MultiTileCGRA.scala 658:29]
  assign pes_1_io_en = io_en_0; // @[MultiTileCGRA.scala 659:26]
  assign pes_1_io_in_0 = gibs_1_io_ipinSE_0; // @[MultiTileCGRA.scala 669:40]
  assign pes_1_io_in_2 = gibs_3_io_ipinNE_0; // @[MultiTileCGRA.scala 688:59]
  assign pes_1_io_in_4 = gibs_1_io_ipinSE_1; // @[MultiTileCGRA.scala 669:40]
  assign pes_2_clock = clock;
  assign pes_2_reset = reset;
  assign pes_2_io_cfg_en = io_cfg_en_0; // @[MultiTileCGRA.scala 1041:70]
  assign pes_2_io_cfg_addr = io_cfg_addr; // @[MultiTileCGRA.scala 1043:70]
  assign pes_2_io_cfg_data = io_cfg_data; // @[MultiTileCGRA.scala 1044:70]
  assign pes_2_io_start = io_start_0; // @[MultiTileCGRA.scala 658:29]
  assign pes_2_io_en = io_en_0; // @[MultiTileCGRA.scala 659:26]
  assign pes_2_io_in_1 = gibs_3_io_ipinSW_0; // @[MultiTileCGRA.scala 678:40]
  assign pes_2_io_in_3 = gibs_5_io_ipinNW_0; // @[MultiTileCGRA.scala 697:40]
  assign pes_2_io_in_7 = gibs_5_io_ipinNW_1; // @[MultiTileCGRA.scala 697:40]
  assign pes_3_clock = clock;
  assign pes_3_reset = reset;
  assign pes_3_io_cfg_en = io_cfg_en_0; // @[MultiTileCGRA.scala 1041:70]
  assign pes_3_io_cfg_addr = io_cfg_addr; // @[MultiTileCGRA.scala 1043:70]
  assign pes_3_io_cfg_data = io_cfg_data; // @[MultiTileCGRA.scala 1044:70]
  assign pes_3_io_start = io_start_0; // @[MultiTileCGRA.scala 658:29]
  assign pes_3_io_en = io_en_0; // @[MultiTileCGRA.scala 659:26]
  assign pes_3_io_in_0 = gibs_3_io_ipinSE_0; // @[MultiTileCGRA.scala 669:40]
  assign pes_3_io_in_2 = gibs_5_io_ipinNE_0; // @[MultiTileCGRA.scala 688:59]
  assign pes_3_io_in_7 = gibs_8_io_ipinNW_1; // @[MultiTileCGRA.scala 933:33]
  assign gibs_0_io_opinNE_0 = iobs_0_io_out_0; // @[MultiTileCGRA.scala 564:37]
  assign gibs_0_io_itrackE_0 = gibs_1_io_otrackW_0; // @[MultiTileCGRA.scala 784:18]
  assign gibs_0_io_itrackS_0 = gibs_2_io_otrackN_0; // @[MultiTileCGRA.scala 749:18]
  assign gibs_1_clock = clock;
  assign gibs_1_reset = reset;
  assign gibs_1_io_cfg_en = io_cfg_en_0; // @[MultiTileCGRA.scala 1036:73]
  assign gibs_1_io_cfg_addr = io_cfg_addr; // @[MultiTileCGRA.scala 1038:73]
  assign gibs_1_io_cfg_data = io_cfg_data; // @[MultiTileCGRA.scala 1039:73]
  assign gibs_1_io_opinNW_0 = iobs_0_io_out_0; // @[MultiTileCGRA.scala 565:39]
  assign gibs_1_io_opinNE_0 = iobs_1_io_out_0; // @[MultiTileCGRA.scala 582:37]
  assign gibs_1_io_opinSE_0 = pes_1_io_out_0; // @[MultiTileCGRA.scala 707:39]
  assign gibs_1_io_itrackW_0 = gibs_0_io_otrackE_0; // @[MultiTileCGRA.scala 792:18]
  assign gibs_1_io_itrackE_0 = gibs_6_io_otrackW_0; // @[MultiTileCGRA.scala 969:16]
  assign gibs_1_io_itrackS_0 = gibs_3_io_otrackN_0; // @[MultiTileCGRA.scala 749:18]
  assign gibs_2_clock = clock;
  assign gibs_2_reset = reset;
  assign gibs_2_io_cfg_en = io_cfg_en_0; // @[MultiTileCGRA.scala 1036:73]
  assign gibs_2_io_cfg_addr = io_cfg_addr; // @[MultiTileCGRA.scala 1038:73]
  assign gibs_2_io_cfg_data = io_cfg_data; // @[MultiTileCGRA.scala 1039:73]
  assign gibs_2_io_itrackN_0 = gibs_0_io_otrackS_0; // @[MultiTileCGRA.scala 764:18]
  assign gibs_2_io_itrackE_0 = gibs_3_io_otrackW_0; // @[MultiTileCGRA.scala 784:18]
  assign gibs_2_io_itrackS_0 = gibs_4_io_otrackN_0; // @[MultiTileCGRA.scala 770:18]
  assign gibs_3_clock = clock;
  assign gibs_3_reset = reset;
  assign gibs_3_io_cfg_en = io_cfg_en_0; // @[MultiTileCGRA.scala 1036:73]
  assign gibs_3_io_cfg_addr = io_cfg_addr; // @[MultiTileCGRA.scala 1038:73]
  assign gibs_3_io_cfg_data = io_cfg_data; // @[MultiTileCGRA.scala 1039:73]
  assign gibs_3_io_opinNW_0 = pes_0_io_out_0; // @[MultiTileCGRA.scala 722:39]
  assign gibs_3_io_opinSE_0 = pes_3_io_out_0; // @[MultiTileCGRA.scala 707:39]
  assign gibs_3_io_itrackW_0 = gibs_2_io_otrackE_0; // @[MultiTileCGRA.scala 792:18]
  assign gibs_3_io_itrackN_0 = gibs_1_io_otrackS_0; // @[MultiTileCGRA.scala 764:18]
  assign gibs_3_io_itrackE_0 = gibs_7_io_otrackW_0; // @[MultiTileCGRA.scala 969:16]
  assign gibs_3_io_itrackS_0 = gibs_5_io_otrackN_0; // @[MultiTileCGRA.scala 770:18]
  assign gibs_4_io_itrackN_0 = gibs_2_io_otrackS_0; // @[MultiTileCGRA.scala 757:18]
  assign gibs_4_io_itrackE_0 = gibs_5_io_otrackW_0; // @[MultiTileCGRA.scala 784:18]
  assign gibs_5_clock = clock;
  assign gibs_5_reset = reset;
  assign gibs_5_io_cfg_en = io_cfg_en_0; // @[MultiTileCGRA.scala 1036:73]
  assign gibs_5_io_cfg_addr = io_cfg_addr; // @[MultiTileCGRA.scala 1038:73]
  assign gibs_5_io_cfg_data = io_cfg_data; // @[MultiTileCGRA.scala 1039:73]
  assign gibs_5_io_opinNW_0 = pes_2_io_out_0; // @[MultiTileCGRA.scala 722:39]
  assign gibs_5_io_opinSE_0 = iobs_3_io_out_0; // @[MultiTileCGRA.scala 632:37]
  assign gibs_5_io_opinSW_0 = iobs_2_io_out_0; // @[MultiTileCGRA.scala 608:41]
  assign gibs_5_io_itrackW_0 = gibs_4_io_otrackE_0; // @[MultiTileCGRA.scala 792:18]
  assign gibs_5_io_itrackN_0 = gibs_3_io_otrackS_0; // @[MultiTileCGRA.scala 757:18]
  assign gibs_5_io_itrackE_0 = gibs_8_io_otrackW_0; // @[MultiTileCGRA.scala 969:16]
  assign gibs_6_io_itrackW_0 = gibs_1_io_otrackE_0; // @[MultiTileCGRA.scala 962:16]
  assign gibs_6_io_itrackS_0 = gibs_7_io_otrackN_0; // @[MultiTileCGRA.scala 986:18]
  assign gibs_7_clock = clock;
  assign gibs_7_reset = reset;
  assign gibs_7_io_cfg_en = io_cfg_en_0; // @[MultiTileCGRA.scala 1049:89]
  assign gibs_7_io_cfg_addr = io_cfg_addr; // @[MultiTileCGRA.scala 1050:89]
  assign gibs_7_io_cfg_data = io_cfg_data; // @[MultiTileCGRA.scala 1051:89]
  assign gibs_7_io_itrackW_0 = gibs_3_io_otrackE_0; // @[MultiTileCGRA.scala 962:16]
  assign gibs_7_io_itrackN_0 = gibs_6_io_otrackS_0; // @[MultiTileCGRA.scala 1001:18]
  assign gibs_7_io_itrackS_0 = gibs_8_io_otrackN_0; // @[MultiTileCGRA.scala 1007:18]
  assign gibs_8_io_opinSW_0 = iobs_3_io_out_0; // @[MultiTileCGRA.scala 901:40]
  assign gibs_8_io_itrackW_0 = gibs_5_io_otrackE_0; // @[MultiTileCGRA.scala 962:16]
  assign gibs_8_io_itrackN_0 = gibs_7_io_otrackS_0; // @[MultiTileCGRA.scala 994:18]
  always @(posedge clock) begin
    io_done_0_REG <= {io_done_0_hi,io_done_0_lo}; // @[MultiTileCGRA.scala 647:35]
  end
// Register and memory initialization
`ifdef RANDOMIZE_GARBAGE_ASSIGN
`define RANDOMIZE
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [1:0] _GEN_4 = waitCnt >= 3'h6 ? 2'h0 : state; // @[ConfigController.scala 61:35 62:15 35:22]
  wire  _GEN_5 = waitCnt >= 3'h6 | done; // @[ConfigController.scala 61:35 63:14 45:21]
...
`endif // RANDOMIZE_REG_INIT
  ...
  assign io_orig_0_we = inSel_0 ? io_coal_0_we : inSel_1 & io_coal_1_we; // @[Mux.scala 101:16]
  ...
  assign io_orig_1_we = _outSel_T_5 ? io_coal_0_we : inSel_1_1 & io_coal_1_we; // @[Mux.scala 101:16]
...
module MultiTileSRAMCoalesce(
  ...
  wire  group_io_orig_0_we; // @[MultiTileSRAMCoalesce.scala 100:25]
  ...
  wire  group_io_orig_1_we; // @[MultiTileSRAMCoalesce.scala 100:25]
  ...
  wire  group_io_coal_0_we; // @[MultiTileSRAMCoalesce.scala 100:25]
  ...
  wire  group_io_coal_1_we; // @[MultiTileSRAMCoalesce.scala 100:25]
  ...
  wire  group_1_io_orig_0_we; // @[MultiTileSRAMCoalesce.scala 100:25]
  ...
  wire  group_1_io_orig_1_we; // @[MultiTileSRAMCoalesce.scala 100:25]
  ...
  wire  group_1_io_coal_0_we; // @[MultiTileSRAMCoalesce.scala 100:25]
  ...
  wire  group_1_io_coal_1_we; // @[MultiTileSRAMCoalesce.scala 100:25]
...
`endif // RANDOMIZE_REG_INIT
  ...
  reg [3:0] iob_ens; // @[VitraCGRAController.scala 260:30]
  ...
  wire [3:0] _GEN_1 = reg_exe_start ? reg_exe_iob_ens_0[3:0] : iob_ens; // @[VitraCGRAController.scala 293:31 295:17 260:30]
  ...
  wire [3:0] _GEN_11 = cfgCtrl_io_done ? iob_ens : _GEN_1; // @[VitraCGRAController.scala 308:28 260:30]
  ...
  wire  _r_data_T_3 = 8'h7 == r_reg_addr ? reg_exe_start : 8'h5 == r_reg_addr & reg_cfg_en; // @[Mux.scala 81:58]
  wire [7:0] _r_data_T_5 = 8'h2 == r_reg_addr ? reg_cfg_num_0 : {{7'd0}, _r_data_T_3}; // @[Mux.scala 81:58]
  wire [7:0] _r_data_T_7 = 8'h4 == r_reg_addr ? reg_cfg_en_tile_0 : _r_data_T_5; // @[Mux.scala 81:58]
  wire [7:0] _r_data_T_9 = 8'h1 == r_reg_addr ? reg_cfg_base_addr_1 : _r_data_T_7; // @[Mux.scala 81:58]
  wire [7:0] _r_data_T_11 = 8'h0 == r_reg_addr ? reg_cfg_base_addr_0 : _r_data_T_9; // @[Mux.scala 81:58]
  wire [7:0] _r_data_T_13 = 8'h6 == r_reg_addr ? reg_exe_iob_ens_0 : _r_data_T_11; // @[Mux.scala 81:58]
  wire [7:0] reg_exe_done_0 = {{7'd0}, tileStates_0_io_exeDone}; // @[VitraCGRAController.scala 171:55 352:40]
  wire [7:0] _r_data_T_15 = 8'h8 == r_reg_addr ? reg_exe_done_0 : _r_data_T_13; // @[Mux.scala 81:58]
  ...
  assign io_s_axilite_r_bits_data = 8'h3 == r_reg_addr ? reg_cfg_num_1 : _r_data_T_15; // @[Mux.scala 81:58]
  ...
  always @(posedge clock) begin
    ...
    cfg_en_tiles <= _GEN_87[0]; // @[VitraCGRAController.scala 259:{30,30}]
    if (reset) begin // @[VitraCGRAController.scala 260:30]
      iob_ens <= 4'h0; // @[VitraCGRAController.scala 260:30]
      ...
      if (!(reg_cfg_en)) begin // @[VitraCGRAController.scala 287:23]
        if (reg_exe_start) begin // @[VitraCGRAController.scala 293:31]
          iob_ens <= reg_exe_iob_ens_0[3:0]; // @[VitraCGRAController.scala 295:17]
        end
      end
...
`ifdef RANDOMIZE_REG_INIT
  ...
  _RAND_10 = {1{`RANDOM}};
  cfg_en_tiles = _RAND_10[0:0];
  _RAND_11 = {1{`RANDOM}};
  iob_ens = _RAND_11[3:0];
  _RAND_12 = {1{`RANDOM}};
...
module vitra(
  ...
  wire [15:0] spad_io_s_axi_aw_bits_addr; // @[VitraWithAxi.scala 131:20]
  ...
  wire [15:0] spad_io_s_axi_ar_bits_addr; // @[VitraWithAxi.scala 131:20]
