...
for.body:                                         ; preds = %if.end20, %entry
  ...
  %0 = getelementptr inbounds [1 x i32], [1 x i32]* @Input0, i32 0, i32 0
  %1 = load i32, i32* %0, align 4, !tbaa !3
  %shr = lshr i32 %1, %type_shift.0111
  %and = and i32 %shr, 3
  %add = add nuw nsw i32 %type_shift.0111, 2
  %Pivot = icmp slt i32 %and, 1
  br i1 %Pivot, label %if.then, label %LeafBlock

LeafBlock:                                        ; preds = %for.body
  %SwitchLeaf = icmp eq i32 %and, 1
  br i1 %SwitchLeaf, label %if.then10, label %if.end20
...
if.then10:                                        ; preds = %LeafBlock
  ...
  store i32 %4, i32* %arrayidx13, align 4, !tbaa !3
...
if.end20:                                         ; preds = %if.then10, %if.then, %LeafBlock
  %outidx1.1 = phi i32 [ %outidx1.0107, %if.then ], [ %add19, %if.then10 ], [ %outidx1.0107, %LeafBlock ]
  %outidx0.1 = phi i32 [ %add8, %if.then ], [ %outidx0.0108, %if.then10 ], [ %outidx0.0108, %LeafBlock ]
  %inc = add nuw nsw i32 %i.0109, 1
  %exitcond115 = icmp eq i32 %inc, 16
  br i1 %exitcond115, label %for.body25.preheader, label %for.body

for.body25.preheader:                             ; preds = %if.end20
  br label %for.body25
...
for.body25:                                       ; preds = %for.body25, %for.body25.preheader
  %i21.0106 = phi i32 [ %inc29, %for.body25 ], [ 0, %for.body25.preheader ]
  %arrayidx26 = getelementptr inbounds [16 x i32], [16 x i32]* @Output0, i32 0, i32 %i21.0106
  %6 = load i32, i32* %arrayidx26, align 4, !tbaa !3
  %call27 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32 %6)
...
for.body36:                                       ; preds = %for.body36, %for.cond.cleanup24
  ...
  %7 = load i32, i32* %arrayidx37, align 4, !tbaa !3
  %call38 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32 %7)
...
for.body47:                                       ; preds = %for.body47, %for.cond.cleanup35
  ...
  %8 = load i32, i32* %arrayidx48, align 4, !tbaa !3
  %call49 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32 %8)
...
for.body58:                                       ; preds = %for.body58, %for.cond.cleanup46
  ...
  %9 = load i32, i32* %arrayidx59, align 4, !tbaa !3
  %call60 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32 %9)
