...
WAVEFORM="sims/waveforms/waveform.vpd"

help () {
  echo "Run a RISCV TRAM program on VCS, a cycle-accurate simulator"
  echo
...
set -x
cd ../../sims/vcs/
./simv-chipyard.harness-TramSoCConfig${DEBUG} $PK $full_binary_path; stty echo
set +x