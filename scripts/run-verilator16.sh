...
WAVEFORM="sims/waveforms16/waveform.vcd"
WAVEFORM_PATH="sims/waveforms16/"
...
if [ $debug -eq 1 ]; then
    ...
    DEBUG="-debug -v ${ROOT}${WAVEFORM_PATH}${binary}.vcd"
else
    DEBUG=""
fi
...
cd ../../sims/verilator16/
echo "./simulator-chipyard-TramSoCConfig${DEBUG} $PK ${full_binary_path}"
